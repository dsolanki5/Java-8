...
public class EmployeeStreamDemo {
	...
	public static void main(String[] args) {
		...
		//1st Solution::
		Function<List<String>, Map<String, Integer>> countOccFunc = (strList) -> {
		...
		System.out.println(countOccFunc.apply(Arrays.asList(str.split(""))));
		
		//2nd Solution::
		Map<String,Long> countOcc = Arrays.stream(str.split(""))
				.collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
		System.out.println("occurances :: "+countOcc);
